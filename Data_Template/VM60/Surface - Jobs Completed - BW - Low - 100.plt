...
#set title "Number of Jobs Completed - 200"
...
set output "SurfaceNumberJobsCompleted_LowBW_200.pdf"
splot for [i=9:17]  "SurfaceA.txt" index i u 5:6:10 lt rgb "gray60" with lines,  \
      for [j=29:57] "SurfaceB.txt" index j u 5:6:10 lt rgb "gray60" with lines
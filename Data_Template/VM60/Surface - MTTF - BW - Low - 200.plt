...
set output "SurfaceMTTF_LowBW_250.pdf"
splot for [i=18:26] "SurfaceA.txt" index i u 5:6:($10*$16/$11) lt rgb "gray60" with lines,  \
      for [j=58:86] "SurfaceB.txt" index j u 5:6:($10*$16/$11) lt rgb "gray60" with lines
...
#set title "Job Completion Time Overhead - 100"
...
set output "SurfaceJobCompletionTime_Overhead_100.pdf"
splot for [i=0:8] "SurfaceA.txt" index i u 5:6:($16-$6) lt rgb "gray60" with lines,  \
      for [j=0:28] "SurfaceB.txt" index j u 5:6:($16-$6) lt rgb "gray60" with lines
